...
// 		$board = $_POST['board_init'];
 		print($_POST['board_init']);
		check($_POST['board_init']);
		
		
// 		if(generate($_POST['board_init']))
// 		{
// 			print $_POST['board_init'];
// 		};
	}
}
echo $_POST['board_init'];
?>
...
<?php
if(in_array("001", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("002", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("003", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("004", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>									
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("011", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("012", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("013", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("014", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>									
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("101", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("102", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("103", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("104", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>									
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("111", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("112", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("113", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("114", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("021", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("022", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("023", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("024", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("031", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("032", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("033", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("034", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("121", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("122", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("123", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("124", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("131", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("132", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("133", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("134", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("201", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("202", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("203", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("204", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("211", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("212", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("213", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("214", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("301", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("302", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("303", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("304", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("311", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("312", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("313", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("314", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("221", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("222", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("223", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("224", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("231", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("232", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("233", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("234", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("321", $_SESSION['choices'])){?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("322", $_SESSION['choices'])){?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("323", $_SESSION['choices'])){?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("324", $_SESSION['choices'])){?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<table border="0" height ="70" width = "100" align="center">
<?php
if(in_array("331", $_SESSION['choices'])){	?> <center><font size="20" face="Times">1</font></center><?php
}elseif(in_array("332", $_SESSION['choices'])){	?> <center><font size="20" face="Times">2</font></center><?php
}elseif(in_array("333", $_SESSION['choices'])){	?> <center><font size="20" face="Times">3</font></center><?php
}elseif(in_array("334", $_SESSION['choices'])){	?> <center><font size="20" face="Times">4</font></center><?php
}else {
?>										
<tr>
...
<center><input type="text" name="board_init"/><input type="submit" name="initialize_board" value="Initialize Board"/></center>
<center><font size="2">(Input Format: XXXX:XXXX:XXXX:XXXX)</font></center>	
<center><input type="submit" value="Clear" name="clear" /></center>
<center><input type="submit" value="Undo" name="undo" /></center>
</form>
